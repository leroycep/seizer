...
pub const GLhandleARB = if (std.builtin.os.tag == .macos) *anyopaque else c_uint;
...
const function_signatures = struct {
    const glActiveTexture = *const fn (_texture: GLenum) void;
    const glAttachShader = *const fn (_program: GLuint, _shader: GLuint) void;
    const glBindAttribLocation = *const fn (_program: GLuint, _index: GLuint, _name: [*c]const GLchar) void;
    const glBindBuffer = *const fn (_target: GLenum, _buffer: GLuint) void;
    const glBindFramebuffer = *const fn (_target: GLenum, _framebuffer: GLuint) void;
    const glBindRenderbuffer = *const fn (_target: GLenum, _renderbuffer: GLuint) void;
    const glBindTexture = *const fn (_target: GLenum, _texture: GLuint) void;
    const glBlendColor = *const fn (_red: GLfloat, _green: GLfloat, _blue: GLfloat, _alpha: GLfloat) void;
    const glBlendEquation = *const fn (_mode: GLenum) void;
    const glBlendEquationSeparate = *const fn (_modeRGB: GLenum, _modeAlpha: GLenum) void;
    const glBlendFunc = *const fn (_sfactor: GLenum, _dfactor: GLenum) void;
    const glBlendFuncSeparate = *const fn (_sfactorRGB: GLenum, _dfactorRGB: GLenum, _sfactorAlpha: GLenum, _dfactorAlpha: GLenum) void;
    const glBufferData = *const fn (_target: GLenum, _size: GLsizeiptr, _data: ?*const anyopaque, _usage: GLenum) void;
    const glBufferSubData = *const fn (_target: GLenum, _offset: GLintptr, _size: GLsizeiptr, _data: ?*const anyopaque) void;
    const glCheckFramebufferStatus = *const fn (_target: GLenum) GLenum;
    const glClear = *const fn (_mask: GLbitfield) void;
    const glClearColor = *const fn (_red: GLfloat, _green: GLfloat, _blue: GLfloat, _alpha: GLfloat) void;
    const glClearDepthf = *const fn (_d: GLfloat) void;
    const glClearStencil = *const fn (_s: GLint) void;
    const glColorMask = *const fn (_red: GLboolean, _green: GLboolean, _blue: GLboolean, _alpha: GLboolean) void;
    const glCompileShader = *const fn (_shader: GLuint) void;
    const glCompressedTexImage2D = *const fn (_target: GLenum, _level: GLint, _internalformat: GLenum, _width: GLsizei, _height: GLsizei, _border: GLint, _imageSize: GLsizei, _data: ?*const anyopaque) void;
    const glCompressedTexSubImage2D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _width: GLsizei, _height: GLsizei, _format: GLenum, _imageSize: GLsizei, _data: ?*const anyopaque) void;
    const glCopyTexImage2D = *const fn (_target: GLenum, _level: GLint, _internalformat: GLenum, _x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei, _border: GLint) void;
    const glCopyTexSubImage2D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei) void;
    const glCreateProgram = *const fn () GLuint;
    const glCreateShader = *const fn (_type: GLenum) GLuint;
    const glCullFace = *const fn (_mode: GLenum) void;
    const glDeleteBuffers = *const fn (_n: GLsizei, _buffers: [*c]const GLuint) void;
    const glDeleteFramebuffers = *const fn (_n: GLsizei, _framebuffers: [*c]const GLuint) void;
    const glDeleteProgram = *const fn (_program: GLuint) void;
    const glDeleteRenderbuffers = *const fn (_n: GLsizei, _renderbuffers: [*c]const GLuint) void;
    const glDeleteShader = *const fn (_shader: GLuint) void;
    const glDeleteTextures = *const fn (_n: GLsizei, _textures: [*c]const GLuint) void;
    const glDepthFunc = *const fn (_func: GLenum) void;
    const glDepthMask = *const fn (_flag: GLboolean) void;
    const glDepthRangef = *const fn (_n: GLfloat, _f: GLfloat) void;
    const glDetachShader = *const fn (_program: GLuint, _shader: GLuint) void;
    const glDisable = *const fn (_cap: GLenum) void;
    const glDisableVertexAttribArray = *const fn (_index: GLuint) void;
    const glDrawArrays = *const fn (_mode: GLenum, _first: GLint, _count: GLsizei) void;
    const glDrawElements = *const fn (_mode: GLenum, _count: GLsizei, _type: GLenum, _indices: ?*const anyopaque) void;
    const glEnable = *const fn (_cap: GLenum) void;
    const glEnableVertexAttribArray = *const fn (_index: GLuint) void;
    const glFinish = *const fn () void;
    const glFlush = *const fn () void;
    const glFramebufferRenderbuffer = *const fn (_target: GLenum, _attachment: GLenum, _renderbuffertarget: GLenum, _renderbuffer: GLuint) void;
    const glFramebufferTexture2D = *const fn (_target: GLenum, _attachment: GLenum, _textarget: GLenum, _texture: GLuint, _level: GLint) void;
    const glFrontFace = *const fn (_mode: GLenum) void;
    const glGenBuffers = *const fn (_n: GLsizei, _buffers: [*c]GLuint) void;
    const glGenerateMipmap = *const fn (_target: GLenum) void;
    const glGenFramebuffers = *const fn (_n: GLsizei, _framebuffers: [*c]GLuint) void;
    const glGenRenderbuffers = *const fn (_n: GLsizei, _renderbuffers: [*c]GLuint) void;
    const glGenTextures = *const fn (_n: GLsizei, _textures: [*c]GLuint) void;
    const glGetActiveAttrib = *const fn (_program: GLuint, _index: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _size: [*c]GLint, _type: [*c]GLenum, _name: [*c]GLchar) void;
    const glGetActiveUniform = *const fn (_program: GLuint, _index: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _size: [*c]GLint, _type: [*c]GLenum, _name: [*c]GLchar) void;
    const glGetAttachedShaders = *const fn (_program: GLuint, _maxCount: GLsizei, _count: [*c]GLsizei, _shaders: [*c]GLuint) void;
    const glGetAttribLocation = *const fn (_program: GLuint, _name: [*c]const GLchar) GLint;
    const glGetBooleanv = *const fn (_pname: GLenum, _data: [*c]GLboolean) void;
    const glGetBufferParameteriv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    const glGetError = *const fn () GLenum;
    const glGetFloatv = *const fn (_pname: GLenum, _data: [*c]GLfloat) void;
    const glGetFramebufferAttachmentParameteriv = *const fn (_target: GLenum, _attachment: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    const glGetIntegerv = *const fn (_pname: GLenum, _data: [*c]GLint) void;
    const glGetProgramiv = *const fn (_program: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glGetProgramInfoLog = *const fn (_program: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _infoLog: [*c]GLchar) void;
    const glGetRenderbufferParameteriv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    const glGetShaderiv = *const fn (_shader: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glGetShaderInfoLog = *const fn (_shader: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _infoLog: [*c]GLchar) void;
    const glGetShaderPrecisionFormat = *const fn (_shadertype: GLenum, _precisiontype: GLenum, _range: [*c]GLint, _precision: [*c]GLint) void;
    const glGetShaderSource = *const fn (_shader: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _source: [*c]GLchar) void;
    const glGetString = *const fn (_name: GLenum) ?[*:0]const GLubyte;
    const glGetTexParameterfv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]GLfloat) void;
    const glGetTexParameteriv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    const glGetUniformfv = *const fn (_program: GLuint, _location: GLint, _params: [*c]GLfloat) void;
    const glGetUniformiv = *const fn (_program: GLuint, _location: GLint, _params: [*c]GLint) void;
    const glGetUniformLocation = *const fn (_program: GLuint, _name: [*c]const GLchar) GLint;
    const glGetVertexAttribfv = *const fn (_index: GLuint, _pname: GLenum, _params: [*c]GLfloat) void;
    const glGetVertexAttribiv = *const fn (_index: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glGetVertexAttribPointerv = *const fn (_index: GLuint, _pname: GLenum, _pointer: ?*?*anyopaque) void;
    const glHint = *const fn (_target: GLenum, _mode: GLenum) void;
    const glIsBuffer = *const fn (_buffer: GLuint) GLboolean;
    const glIsEnabled = *const fn (_cap: GLenum) GLboolean;
    const glIsFramebuffer = *const fn (_framebuffer: GLuint) GLboolean;
    const glIsProgram = *const fn (_program: GLuint) GLboolean;
    const glIsRenderbuffer = *const fn (_renderbuffer: GLuint) GLboolean;
    const glIsShader = *const fn (_shader: GLuint) GLboolean;
    const glIsTexture = *const fn (_texture: GLuint) GLboolean;
    const glLineWidth = *const fn (_width: GLfloat) void;
    const glLinkProgram = *const fn (_program: GLuint) void;
    const glPixelStorei = *const fn (_pname: GLenum, _param: GLint) void;
    const glPolygonOffset = *const fn (_factor: GLfloat, _units: GLfloat) void;
    const glReadPixels = *const fn (_x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei, _format: GLenum, _type: GLenum, _pixels: ?*anyopaque) void;
    const glReleaseShaderCompiler = *const fn () void;
    const glRenderbufferStorage = *const fn (_target: GLenum, _internalformat: GLenum, _width: GLsizei, _height: GLsizei) void;
    const glSampleCoverage = *const fn (_value: GLfloat, _invert: GLboolean) void;
    const glScissor = *const fn (_x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei) void;
    const glShaderBinary = *const fn (_count: GLsizei, _shaders: [*c]const GLuint, _binaryFormat: GLenum, _binary: ?*const anyopaque, _length: GLsizei) void;
    const glShaderSource = *const fn (_shader: GLuint, _count: GLsizei, _string: [*c]const [*c]const GLchar, _length: [*c]const GLint) void;
    const glStencilFunc = *const fn (_func: GLenum, _ref: GLint, _mask: GLuint) void;
    const glStencilFuncSeparate = *const fn (_face: GLenum, _func: GLenum, _ref: GLint, _mask: GLuint) void;
    const glStencilMask = *const fn (_mask: GLuint) void;
    const glStencilMaskSeparate = *const fn (_face: GLenum, _mask: GLuint) void;
    const glStencilOp = *const fn (_fail: GLenum, _zfail: GLenum, _zpass: GLenum) void;
    const glStencilOpSeparate = *const fn (_face: GLenum, _sfail: GLenum, _dpfail: GLenum, _dppass: GLenum) void;
    const glTexImage2D = *const fn (_target: GLenum, _level: GLint, _internalformat: GLint, _width: GLsizei, _height: GLsizei, _border: GLint, _format: GLenum, _type: GLenum, _pixels: ?*const anyopaque) void;
    const glTexParameterf = *const fn (_target: GLenum, _pname: GLenum, _param: GLfloat) void;
    const glTexParameterfv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]const GLfloat) void;
    const glTexParameteri = *const fn (_target: GLenum, _pname: GLenum, _param: GLint) void;
    const glTexParameteriv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]const GLint) void;
    const glTexSubImage2D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _width: GLsizei, _height: GLsizei, _format: GLenum, _type: GLenum, _pixels: ?*const anyopaque) void;
    const glUniform1f = *const fn (_location: GLint, _v0: GLfloat) void;
    const glUniform1fv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLfloat) void;
    const glUniform1i = *const fn (_location: GLint, _v0: GLint) void;
    const glUniform1iv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLint) void;
    const glUniform2f = *const fn (_location: GLint, _v0: GLfloat, _v1: GLfloat) void;
    const glUniform2fv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLfloat) void;
    const glUniform2i = *const fn (_location: GLint, _v0: GLint, _v1: GLint) void;
    const glUniform2iv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLint) void;
    const glUniform3f = *const fn (_location: GLint, _v0: GLfloat, _v1: GLfloat, _v2: GLfloat) void;
    const glUniform3fv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLfloat) void;
    const glUniform3i = *const fn (_location: GLint, _v0: GLint, _v1: GLint, _v2: GLint) void;
    const glUniform3iv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLint) void;
    const glUniform4f = *const fn (_location: GLint, _v0: GLfloat, _v1: GLfloat, _v2: GLfloat, _v3: GLfloat) void;
    const glUniform4fv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLfloat) void;
    const glUniform4i = *const fn (_location: GLint, _v0: GLint, _v1: GLint, _v2: GLint, _v3: GLint) void;
    const glUniform4iv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLint) void;
    const glUniformMatrix2fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glUniformMatrix3fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glUniformMatrix4fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glUseProgram = *const fn (_program: GLuint) void;
    const glValidateProgram = *const fn (_program: GLuint) void;
    const glVertexAttrib1f = *const fn (_index: GLuint, _x: GLfloat) void;
    const glVertexAttrib1fv = *const fn (_index: GLuint, _v: [*c]const GLfloat) void;
    const glVertexAttrib2f = *const fn (_index: GLuint, _x: GLfloat, _y: GLfloat) void;
    const glVertexAttrib2fv = *const fn (_index: GLuint, _v: [*c]const GLfloat) void;
    const glVertexAttrib3f = *const fn (_index: GLuint, _x: GLfloat, _y: GLfloat, _z: GLfloat) void;
    const glVertexAttrib3fv = *const fn (_index: GLuint, _v: [*c]const GLfloat) void;
    const glVertexAttrib4f = *const fn (_index: GLuint, _x: GLfloat, _y: GLfloat, _z: GLfloat, _w: GLfloat) void;
    const glVertexAttrib4fv = *const fn (_index: GLuint, _v: [*c]const GLfloat) void;
    const glVertexAttribPointer = *const fn (_index: GLuint, _size: GLint, _type: GLenum, _normalized: GLboolean, _stride: GLsizei, _pointer: ?*const anyopaque) void;
    const glViewport = *const fn (_x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei) void;
    const glReadBuffer = *const fn (_src: GLenum) void;
    const glDrawRangeElements = *const fn (_mode: GLenum, _start: GLuint, _end: GLuint, _count: GLsizei, _type: GLenum, _indices: ?*const anyopaque) void;
    const glTexImage3D = *const fn (_target: GLenum, _level: GLint, _internalformat: GLint, _width: GLsizei, _height: GLsizei, _depth: GLsizei, _border: GLint, _format: GLenum, _type: GLenum, _pixels: ?*const anyopaque) void;
    const glTexSubImage3D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _zoffset: GLint, _width: GLsizei, _height: GLsizei, _depth: GLsizei, _format: GLenum, _type: GLenum, _pixels: ?*const anyopaque) void;
    const glCopyTexSubImage3D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _zoffset: GLint, _x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei) void;
    const glCompressedTexImage3D = *const fn (_target: GLenum, _level: GLint, _internalformat: GLenum, _width: GLsizei, _height: GLsizei, _depth: GLsizei, _border: GLint, _imageSize: GLsizei, _data: ?*const anyopaque) void;
    const glCompressedTexSubImage3D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _zoffset: GLint, _width: GLsizei, _height: GLsizei, _depth: GLsizei, _format: GLenum, _imageSize: GLsizei, _data: ?*const anyopaque) void;
    const glGenQueries = *const fn (_n: GLsizei, _ids: [*c]GLuint) void;
    const glDeleteQueries = *const fn (_n: GLsizei, _ids: [*c]const GLuint) void;
    const glIsQuery = *const fn (_id: GLuint) GLboolean;
    const glBeginQuery = *const fn (_target: GLenum, _id: GLuint) void;
    const glEndQuery = *const fn (_target: GLenum) void;
    const glGetQueryiv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    const glGetQueryObjectuiv = *const fn (_id: GLuint, _pname: GLenum, _params: [*c]GLuint) void;
    const glUnmapBuffer = *const fn (_target: GLenum) GLboolean;
    const glGetBufferPointerv = *const fn (_target: GLenum, _pname: GLenum, _params: ?*?*anyopaque) void;
    const glDrawBuffers = *const fn (_n: GLsizei, _bufs: [*c]const GLenum) void;
    const glUniformMatrix2x3fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glUniformMatrix3x2fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glUniformMatrix2x4fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glUniformMatrix4x2fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glUniformMatrix3x4fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glUniformMatrix4x3fv = *const fn (_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    const glBlitFramebuffer = *const fn (_srcX0: GLint, _srcY0: GLint, _srcX1: GLint, _srcY1: GLint, _dstX0: GLint, _dstY0: GLint, _dstX1: GLint, _dstY1: GLint, _mask: GLbitfield, _filter: GLenum) void;
    const glRenderbufferStorageMultisample = *const fn (_target: GLenum, _samples: GLsizei, _internalformat: GLenum, _width: GLsizei, _height: GLsizei) void;
    const glFramebufferTextureLayer = *const fn (_target: GLenum, _attachment: GLenum, _texture: GLuint, _level: GLint, _layer: GLint) void;
    const glMapBufferRange = *const fn (_target: GLenum, _offset: GLintptr, _length: GLsizeiptr, _access: GLbitfield) ?*anyopaque;
    const glFlushMappedBufferRange = *const fn (_target: GLenum, _offset: GLintptr, _length: GLsizeiptr) void;
    const glBindVertexArray = *const fn (_array: GLuint) void;
    const glDeleteVertexArrays = *const fn (_n: GLsizei, _arrays: [*c]const GLuint) void;
    const glGenVertexArrays = *const fn (_n: GLsizei, _arrays: [*c]GLuint) void;
    const glIsVertexArray = *const fn (_array: GLuint) GLboolean;
    const glGetIntegeri_v = *const fn (_target: GLenum, _index: GLuint, _data: [*c]GLint) void;
    const glBeginTransformFeedback = *const fn (_primitiveMode: GLenum) void;
    const glEndTransformFeedback = *const fn () void;
    const glBindBufferRange = *const fn (_target: GLenum, _index: GLuint, _buffer: GLuint, _offset: GLintptr, _size: GLsizeiptr) void;
    const glBindBufferBase = *const fn (_target: GLenum, _index: GLuint, _buffer: GLuint) void;
    const glTransformFeedbackVaryings = *const fn (_program: GLuint, _count: GLsizei, _varyings: [*c]const [*c]const GLchar, _bufferMode: GLenum) void;
    const glGetTransformFeedbackVarying = *const fn (_program: GLuint, _index: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _size: [*c]GLsizei, _type: [*c]GLenum, _name: [*c]GLchar) void;
    const glVertexAttribIPointer = *const fn (_index: GLuint, _size: GLint, _type: GLenum, _stride: GLsizei, _pointer: ?*const anyopaque) void;
    const glGetVertexAttribIiv = *const fn (_index: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glGetVertexAttribIuiv = *const fn (_index: GLuint, _pname: GLenum, _params: [*c]GLuint) void;
    const glVertexAttribI4i = *const fn (_index: GLuint, _x: GLint, _y: GLint, _z: GLint, _w: GLint) void;
    const glVertexAttribI4ui = *const fn (_index: GLuint, _x: GLuint, _y: GLuint, _z: GLuint, _w: GLuint) void;
    const glVertexAttribI4iv = *const fn (_index: GLuint, _v: [*c]const GLint) void;
    const glVertexAttribI4uiv = *const fn (_index: GLuint, _v: [*c]const GLuint) void;
    const glGetUniformuiv = *const fn (_program: GLuint, _location: GLint, _params: [*c]GLuint) void;
    const glGetFragDataLocation = *const fn (_program: GLuint, _name: [*c]const GLchar) GLint;
    const glUniform1ui = *const fn (_location: GLint, _v0: GLuint) void;
    const glUniform2ui = *const fn (_location: GLint, _v0: GLuint, _v1: GLuint) void;
    const glUniform3ui = *const fn (_location: GLint, _v0: GLuint, _v1: GLuint, _v2: GLuint) void;
    const glUniform4ui = *const fn (_location: GLint, _v0: GLuint, _v1: GLuint, _v2: GLuint, _v3: GLuint) void;
    const glUniform1uiv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLuint) void;
    const glUniform2uiv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLuint) void;
    const glUniform3uiv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLuint) void;
    const glUniform4uiv = *const fn (_location: GLint, _count: GLsizei, _value: [*c]const GLuint) void;
    const glClearBufferiv = *const fn (_buffer: GLenum, _drawbuffer: GLint, _value: [*c]const GLint) void;
    const glClearBufferuiv = *const fn (_buffer: GLenum, _drawbuffer: GLint, _value: [*c]const GLuint) void;
    const glClearBufferfv = *const fn (_buffer: GLenum, _drawbuffer: GLint, _value: [*c]const GLfloat) void;
    const glClearBufferfi = *const fn (_buffer: GLenum, _drawbuffer: GLint, _depth: GLfloat, _stencil: GLint) void;
    const glGetStringi = *const fn (_name: GLenum, _index: GLuint) ?[*:0]const GLubyte;
    const glCopyBufferSubData = *const fn (_readTarget: GLenum, _writeTarget: GLenum, _readOffset: GLintptr, _writeOffset: GLintptr, _size: GLsizeiptr) void;
    const glGetUniformIndices = *const fn (_program: GLuint, _uniformCount: GLsizei, _uniformNames: [*c]const [*c]const GLchar, _uniformIndices: [*c]GLuint) void;
    const glGetActiveUniformsiv = *const fn (_program: GLuint, _uniformCount: GLsizei, _uniformIndices: [*c]const GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glGetUniformBlockIndex = *const fn (_program: GLuint, _uniformBlockName: [*c]const GLchar) GLuint;
    const glGetActiveUniformBlockiv = *const fn (_program: GLuint, _uniformBlockIndex: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glGetActiveUniformBlockName = *const fn (_program: GLuint, _uniformBlockIndex: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _uniformBlockName: [*c]GLchar) void;
    const glUniformBlockBinding = *const fn (_program: GLuint, _uniformBlockIndex: GLuint, _uniformBlockBinding: GLuint) void;
    const glDrawArraysInstanced = *const fn (_mode: GLenum, _first: GLint, _count: GLsizei, _instancecount: GLsizei) void;
    const glDrawElementsInstanced = *const fn (_mode: GLenum, _count: GLsizei, _type: GLenum, _indices: ?*const anyopaque, _instancecount: GLsizei) void;
    const glFenceSync = *const fn (_condition: GLenum, _flags: GLbitfield) GLsync;
    const glIsSync = *const fn (_sync: GLsync) GLboolean;
    const glDeleteSync = *const fn (_sync: GLsync) void;
    const glClientWaitSync = *const fn (_sync: GLsync, _flags: GLbitfield, _timeout: GLuint64) GLenum;
    const glWaitSync = *const fn (_sync: GLsync, _flags: GLbitfield, _timeout: GLuint64) void;
    const glGetInteger64v = *const fn (_pname: GLenum, _data: [*c]GLint64) void;
    const glGetSynciv = *const fn (_sync: GLsync, _pname: GLenum, _count: GLsizei, _length: [*c]GLsizei, _values: [*c]GLint) void;
    const glGetInteger64i_v = *const fn (_target: GLenum, _index: GLuint, _data: [*c]GLint64) void;
    const glGetBufferParameteri64v = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]GLint64) void;
    const glGenSamplers = *const fn (_count: GLsizei, _samplers: [*c]GLuint) void;
    const glDeleteSamplers = *const fn (_count: GLsizei, _samplers: [*c]const GLuint) void;
    const glIsSampler = *const fn (_sampler: GLuint) GLboolean;
    const glBindSampler = *const fn (_unit: GLuint, _sampler: GLuint) void;
    const glSamplerParameteri = *const fn (_sampler: GLuint, _pname: GLenum, _param: GLint) void;
    const glSamplerParameteriv = *const fn (_sampler: GLuint, _pname: GLenum, _param: [*c]const GLint) void;
    const glSamplerParameterf = *const fn (_sampler: GLuint, _pname: GLenum, _param: GLfloat) void;
    const glSamplerParameterfv = *const fn (_sampler: GLuint, _pname: GLenum, _param: [*c]const GLfloat) void;
    const glGetSamplerParameteriv = *const fn (_sampler: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glGetSamplerParameterfv = *const fn (_sampler: GLuint, _pname: GLenum, _params: [*c]GLfloat) void;
    const glVertexAttribDivisor = *const fn (_index: GLuint, _divisor: GLuint) void;
    const glBindTransformFeedback = *const fn (_target: GLenum, _id: GLuint) void;
    const glDeleteTransformFeedbacks = *const fn (_n: GLsizei, _ids: [*c]const GLuint) void;
    const glGenTransformFeedbacks = *const fn (_n: GLsizei, _ids: [*c]GLuint) void;
    const glIsTransformFeedback = *const fn (_id: GLuint) GLboolean;
    const glPauseTransformFeedback = *const fn () void;
    const glResumeTransformFeedback = *const fn () void;
    const glGetProgramBinary = *const fn (_program: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _binaryFormat: [*c]GLenum, _binary: ?*anyopaque) void;
    const glProgramBinary = *const fn (_program: GLuint, _binaryFormat: GLenum, _binary: ?*const anyopaque, _length: GLsizei) void;
    const glProgramParameteri = *const fn (_program: GLuint, _pname: GLenum, _value: GLint) void;
    const glInvalidateFramebuffer = *const fn (_target: GLenum, _numAttachments: GLsizei, _attachments: [*c]const GLenum) void;
    const glInvalidateSubFramebuffer = *const fn (_target: GLenum, _numAttachments: GLsizei, _attachments: [*c]const GLenum, _x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei) void;
    const glTexStorage2D = *const fn (_target: GLenum, _levels: GLsizei, _internalformat: GLenum, _width: GLsizei, _height: GLsizei) void;
    const glTexStorage3D = *const fn (_target: GLenum, _levels: GLsizei, _internalformat: GLenum, _width: GLsizei, _height: GLsizei, _depth: GLsizei) void;
    const glGetInternalformativ = *const fn (_target: GLenum, _internalformat: GLenum, _pname: GLenum, _count: GLsizei, _params: [*c]GLint) void;
};
