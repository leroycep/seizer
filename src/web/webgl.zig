...
pub extern fn bufferData(type: c_uint, count: c_long, data_ptr: ?*const anyopaque, draw_type: c_uint) void;
...
pub extern fn deleteTextures(count: GLsizei, id: [*c]const GLuint) void;
...
pub extern fn drawElements(mode: GLenum, count: GLsizei, type: GLenum, offset: ?*const anyopaque) void;
...
pub extern fn vertexAttribPointer(attrib_location: c_uint, size: c_uint, type: c_uint, normalize: c_uint, stride: c_uint, offset: ?*const anyopaque) void;
