...
//
// This code was taken from the wasm-4 project: https://github.com/aduros/wasm4/blob/main/runtimes/web/src/z85.ts

const Z85_ENCODER = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.-:+=^!/*?&<>()[]{}@%$#".split("");
...
function z85_decode(string, dest) {
    let byte_nbr = 0,
        char_nbr = 0,
        value = 0;
